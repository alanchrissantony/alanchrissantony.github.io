<template>
    <div>
        <Titles :viewport="viewport" scene="bizTitle">
            <h1 class="title">
                I am a self-taught <p class="params">Python developer</p>
            </h1>
            <p class="-small_content -gray title">&lt;table&gt;&lt;tr&gt;&lt;td&gt;...</p>
        </Titles>
        ...
        <section class="scene" id="biz1">
            <div class="static-container">
                <div class="std">
                    <p class="-big">
                        I'm a weird guy <b class="-purple">who likes making weird things with technologies</b> and has focused research on <b class="-purple">software development</b>
                        <a href="https://www.bizcommerce.com.br/" target="_blank" title="Visit Biz Commerce's website"></a>
                    </p>
                    <p>
                        to make the world a more connected and unified
                        <a href="https://magento.com/" target="_blank" title="Visit Magento's website" class="disguised-link"></a>place.
                    </p>
                </div>
            </div>
            <div class="container">
        ...
        <section class="scene" id="biz2">
            <div class="static-container">
                <div class="std">
                    <p>
                        I like to resolve programming problems,
                        <span class="-big -purple">use innovative methods, imagine useful interaction and develop rich</span>
        ...
        <section class="scene" id="biz3">
            <div class="static-container">
                <div class="std">
                    <p>       
                        <span class="-big">
                            <span class="-purple">When not</span> working or futzing around with code,<span class="-purple"> I study how to escape from University.</span>
                        </span>
                        Actually for hire.
                    </p>
                </div>
