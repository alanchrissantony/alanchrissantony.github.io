    ...
    <div id="home" class="wrapper">
        ...
        <Titles :viewport="viewport" scene="curriculum">
            ...
            <h1 class="title" v-else>
                myCV(<span class="params">/^.*$/gi</span>)
            </h1>
            <div class="std">
                <p class="-gray">&lt;WorkShowcase&gt;</p>
            </div>
        </Titles>
        ...
        <Titles :viewport="viewport" scene="ArtPhiGamesTitle">
            <h1 class="title">
                ...
                <span class="line"><span class="params">&nbsp;${</span>Music<span class="params">}</span></span>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            progressAnimation(){
                let python = document.getElementById('python_progress')
                python.style.width = python.getAttribute('percentage')+`%`

                let js = document.getElementById('js_progress')
                js.style.width = js.getAttribute('percentage')+`%`

                let linux = document.getElementById('linux_progress')
                linux.style.width = linux.getAttribute('percentage')+`%`
            },
            sceneWrapper(){
